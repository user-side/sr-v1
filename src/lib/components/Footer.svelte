	...
	<div class="row-gap-6 mb-8 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
		<div class="sm:col-span-2">
			<a href="/" aria-label="Go home" title="Company" class="inline-flex items-center">
				...
				<span class="ml-2 text-xl font-bold uppercase tracking-wide text-gray-800"
					>Adi-raj-company</span
				>
			</a>
			<div class="mt-6 lg:max-w-sm">
				<p class="text-sm text-gray-800">
					This company was founded and managed by adi-raj in and from central University Haryana
				</p>
				<p class="mt-4 text-sm text-gray-800">Since we donot have anything else to do</p>
			</div>
		</div>
		...
		<div>
			...
			<p class="mt-4 text-sm text-gray-500">
				You can follow me on insta(since my following list is much higher than my followers list), X
				and on facebook
			</p>
		</div>
	</div>
	<div class="flex flex-col-reverse justify-between border-t pb-10 pt-5 lg:flex-row">
		<p class="text-sm text-gray-600">© Copyright 2024 Inc. All rights reserved.</p>
